...
def main():
    ...
    parser.add_argument("user_prompt", type=str, help="Provide Jarvis a Prompt")
    ...
    if not result_achieved:
        print("couldn't produce final response within the maximum allowed iterations")
        exit(1)
